from utils import validar_data, validar_nome, validar_nacionalidade, validar_telefone, validar_email, validar_NIF, validar_interesses, validar_orcamento, verificar_viajantes
