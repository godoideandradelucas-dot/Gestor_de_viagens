...
def verificar_hoteis(hoteis):
    if not hoteis:
        print("Não há viagens registradas!\n")
        return False
    return True
...
def validar_nacionalidade():
    ...
    while not nacionalidade.isalpha():
...
def validar_email():
    ...
    while not "@gmail.com" in email:
        print("Erro: email inválido!")
        email = input("Digite seu email novamente(@gmail.com): ")
    return email
